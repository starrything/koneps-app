...
import CanvasOfTable from "~/components/chart/make-chart/canvas/CanvasOfTable";
import CanvasOfTableQuery from "~/components/chart/make-chart/canvas/CanvasOfTableQuery";
import CanvasOfLineChart from "~/components/chart/make-chart/canvas/CanvasOfLineChart";
import CanvasOfLineChartQuery from "~/components/chart/make-chart/canvas/CanvasOfLineChartQuery";
import CanvasOfBarChart from "~/components/chart/make-chart/canvas/CanvasOfBarChart";
import CanvasOfBarChartQuery from "~/components/chart/make-chart/canvas/CanvasOfBarChartQuery";
import CanvasOfPieChart from "~/components/chart/make-chart/canvas/CanvasOfPieChart";
import CanvasOfPieChartQuery from "~/components/chart/make-chart/canvas/CanvasOfPieChartQuery";
import CanvasOfBubbleChart from "~/components/chart/make-chart/canvas/CanvasOfBubbleChart";
import CanvasOfBubbleChartQuery from "~/components/chart/make-chart/canvas/CanvasOfBubbleChartQuery";
import CanvasOfBigNumber from "~/components/chart/make-chart/canvas/CanvasOfBigNumber";
import CanvasOfBigNumberQuery from "~/components/chart/make-chart/canvas/CanvasOfBigNumberQuery";
import CanvasOfFilterBox from "~/components/chart/make-chart/canvas/CanvasOfFilterBox";
import CanvasOfFilterBoxQuery from "~/components/chart/make-chart/canvas/CanvasOfFilterBoxQuery";
